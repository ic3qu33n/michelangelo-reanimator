...
def vxinfect(mal_mbr, disk_img, sector_number, vxpaint, vxsectornumber):
    with open(mal_mbr, 'rb') as mbr_file:
        ...
        with open(vxpaint, 'rb') as vxpaintfile:
            ...
            with open(disk_img, "w+b") as disk_img_file:
                ...
                vxpaint_offset=vxsectornumber*512
...
if __name__ == '__main__':
    ...
    if vx_paint == None:
        ...
        if mal_mbr != None:
            if og_mbr == None:
               vxinfect(mal_mbr, disk_img, sector, vx_paint, vx_paintsector) 
            else:
