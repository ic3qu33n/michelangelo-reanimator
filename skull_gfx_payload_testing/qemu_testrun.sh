...
#sudo cp ~/Desktop/b00tkit_testing/skull_gfx_payload_testing/$BIN2copy skullgrafx.com
sudo cp ~/Desktop/b00tkit_testing/skull_gfx_payload_testing/$BIN2copy $OUTPUTBINname
cd ~/Desktop/b00tkit_testing/skull_gfx_payload_testing
